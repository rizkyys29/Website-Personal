...
<html>
<head>
	<title>AL-FATTA-Cake Backery</title>
		...
		<div class="row top">
			<center>
				<div class="col-md-4" style="padding: 3px;">
					<span> <a href="https://api.whatsapp.com/send?phone=6285835603558">Live Chat</a></span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span><i class="glyphicon glyphicon-envelope"></i> AL-FATTA-cakebakery@gmail.com</span>
				</div>


				<div class="col-md-4"  style="padding: 3px;">
					<span>AL-FATTA-cake bakery Indonesia</span>
				</div>
			</center>
		</div>
	</div>
	...
	<nav class="navbar navbar-default" style="padding: 5px;">
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#" style="color: #ff8680"><b>AL-FATTA-CAKE BAKERY</b></a>
			</div>
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav navbar-right">
					...
					<li><a href="manual.php">Manual Pembayaran</a></li>
					<?php 
					if(isset($_SESSION['kd_cs'])){
					$kode_cs = $_SESSION['kd_cs'];
